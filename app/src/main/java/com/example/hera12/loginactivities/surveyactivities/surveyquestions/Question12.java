...
public class Question12 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(MapSurveyDataBase.patientData.get("Waist to Hip ratio") != null){
            answerText.setText(String.valueOf(MapSurveyDataBase.patientData.get("Waist to Hip ratio")));
        }
        ...
        submitBtn.setOnClickListener(view -> {
            ...
            if(answer.isEmpty()){
                ...
                MapSurveyDataBase.patientData.put("Waist to Hip ratio", answer);
