    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        submitBtn.setOnClickListener(view -> {
            ...
            if(answer.isEmpty()){
                ...
                MapSurveyDataBase.patientData.put("FSH level", answer);
        ...
        if(MapSurveyDataBase.patientData.get("FSH level") != null){
            answerText.setText(String.valueOf(MapSurveyDataBase.patientData.get("FSH level")));
            answerText.setTextColor(getResources().getColor(R.color.Green, null));
        }
