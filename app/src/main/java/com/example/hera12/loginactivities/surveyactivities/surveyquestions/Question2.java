    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        yesBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MapSurveyDataBase.patientData.put("Hair Growth", "1");
        ...
        noBtn.setOnClickListener(new View.OnClickListener()    {
            @Override
            public void onClick(View view) {
                MapSurveyDataBase.patientData.put("Hair Growth", "0");
        ...
        if(MapSurveyDataBase.patientData.get("Hair Growth") != null){
            if(1.0f == Float.parseFloat(String.valueOf(MapSurveyDataBase.patientData.get("Hair Growth")))){
                yesBtn.setBackgroundTintList(ContextCompat.getColorStateList(myFragment.getContext(), R.color.Green));
                noBtn.setBackgroundTintList(ContextCompat.getColorStateList(myFragment.getContext(), R.color.Red));
            }
            else {
