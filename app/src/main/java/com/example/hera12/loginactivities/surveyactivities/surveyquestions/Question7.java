...
public class Question7 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(MapSurveyDataBase.patientData.get("FSH and LH ratio") != null){
            answerText.setText(String.valueOf(MapSurveyDataBase.patientData.get("FSH and LH ratio")));
        }
        ...
        submitBtn.setOnClickListener(view -> {
            ...
            if(answer.isEmpty()){
                ...
                MapSurveyDataBase.patientData.put("FSH and LH ratio", answer);
