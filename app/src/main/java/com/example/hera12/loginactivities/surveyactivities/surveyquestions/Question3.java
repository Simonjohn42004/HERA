    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        yesBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MapSurveyDataBase.patientData.put("Skin Darkening", "1");
        ...
        noBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MapSurveyDataBase.patientData.put("Skin Darkening", "0");
        ...
        if(MapSurveyDataBase.patientData.get("Skin Darkening") != null){
            if(1.0f == Float.parseFloat(String.valueOf(MapSurveyDataBase.patientData.get("Skin Darkening")))){
                yesBtn.setBackgroundTintList(ContextCompat.getColorStateList(myFragment.getContext(), R.color.Green));
                noBtn.setBackgroundTintList(ContextCompat.getColorStateList(myFragment.getContext(), R.color.Red));
            }
            else {
