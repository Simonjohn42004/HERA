...
public class Question11 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(MapSurveyDataBase.patientData.get("2 BETA level") != null){
            answerText.setText(String.valueOf(MapSurveyDataBase.patientData.get("2 BETA level")));
        }
        ...
        submitBtn.setOnClickListener(view -> {
            ...
            if(answer.isEmpty()){
                ...
                MapSurveyDataBase.patientData.put("2 BETA level", answer);
