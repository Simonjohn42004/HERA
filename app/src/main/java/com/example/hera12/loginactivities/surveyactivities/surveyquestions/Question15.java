...
public class Question15 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(MapSurveyDataBase.patientData.get("Number of left Follicle") != null){
            answerText.setText(String.valueOf(MapSurveyDataBase.patientData.get("Number of left Follicle")));
        }
        ...
        submitBtn.setOnClickListener(view -> {
            ...
            if(answer.isEmpty()){
                ...
                MapSurveyDataBase.patientData.put("Number of left Follicle", answer);
