...
public class Question14 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(MapSurveyDataBase.patientData.get("Waist length") != null){
            answerText.setText(String.valueOf(MapSurveyDataBase.patientData.get("Waist length")));
        }
        ...
        submitBtn.setOnClickListener(view -> {
            ...
            if(answer.isEmpty()){
                ...
                MapSurveyDataBase.patientData.put("Waist length", answer);
